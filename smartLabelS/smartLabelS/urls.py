...
urlpatterns = patterns('',
    ...
    #url(r'^testmap/(?P<pk>\d+)$', 'test_smartLabelS.views.testmap', name='testmap'),
    url(r'^choose/$','test_smartLabelS.views.choose', name='choose'),
    url(r'^create/$','test_smartLabelS.views.create', name='create'),
     url(r'^monitor/$','test_smartLabelS.views.monitor', name='monitor'),
    url(r'^product/$','test_smartLabelS.views.product', name='product'),
    url(r'^cities/$','test_smartLabelS.views.cities', name='cities'),
